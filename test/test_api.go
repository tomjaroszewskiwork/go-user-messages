...
func CodeTest(t *testing.T, method string, url string, body interface{}, expectedCode int) *httptest.ResponseRecorder {
	return responseTest(t, method, url, body, expectedCode)
}

// BodyResponseTest calls the API and compares the full body return
func BodyResponseTest(t *testing.T, method string, url string, body interface{}, exectedCode int, expectedResponseFile string) *httptest.ResponseRecorder {
